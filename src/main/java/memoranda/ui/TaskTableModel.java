...
public class TaskTableModel extends AbstractTreeTableModel implements TreeTableModel {
     ...
     * can see for instructor todo items). 
     * @return true if the table is only supposed to display 
     * items that are checked as is in reduced. 
     */
    public static boolean check_isInReducedOnly() {
        Object o = Context.get("SHOW_REDUCED_ONLY");
        if (o == null) {
            return false;
        }
        return o.toString().equals("true");           
