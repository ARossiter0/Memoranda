...
public class EditTypeDialog extends JDialog {
	...
	void jbInit() throws Exception {
		...
		// Create and style several titled borders for:
		...
		// Initialize the header and title
		flowLayout7.setAlignment(FlowLayout.LEFT);
		header.setFont(new java.awt.Font("Dialog", 0, 20));
		header.setForeground(new Color(0, 0, 124));
		header.setText(Local.getString("Resource type"));
		header.setIcon(
				new ImageIcon(memoranda.ui.EditTypeDialog.class.getResource("/ui/icons/resource48.png")));
		...
		// Initialize the set icon button
		...
		// Add elements to panels, and ultimately to this content pane
	...
	/**
	 * Cancel the edit type dialog, and dispose of it. 
	 * @param e the action event associated with the cancel button
	 */
	...
	/**
	 * Confirm the edit, and dispose of the edit type dialog. 
	 * @param e the action event associated with the ok button
	 */
	...
	/**
	 * Check if the extension is enabled when updating the 
	 * caret in the extension field
	...
	/**
	 * Check if the ok button is enabled (if the extension field
	...
	/**
	 * Set the icon for the extension type
	 * @param e the action event associated with the set icon button
	 */
