...
public class TaskTableSorter extends TaskTableModel {
    ...
    /**
     * Get the child object of a parent at a given index.
    ...
    public Object getChild(Object parent, int index) {
        ...
        if (parent instanceof Project) {
            if (activeOnly()) {
                c = taskList.getActiveSubTasks(null, CurrentDate.get());
            } else {
                c = taskList.getTopLevelTasks();
            }
        } else {
            Task t = (Task) parent;
            if (activeOnly()) {
                c = taskList.getActiveSubTasks(t.getID(), CurrentDate.get());
            } else {
                c = t.getSubTasks();
            }
        }
