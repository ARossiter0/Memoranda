...
public class ProjectDialog extends JDialog {
	...
	void jbInit() throws Exception {
		...
		// Style the top panel and header
		...
		header.setIcon(
				new ImageIcon(main.java.memoranda.ui.ProjectDialog.class.getResource("/ui/icons/project48.png")));
		topPanel.add(header);

		
		// Create a center panel for the content. 
		...
		// Style the start date label, and add it to center panel. 
		...
		// Style the start date spinner, initialize it, and add it to center panel
		...
		// Style the start date button and add it to the center panel. 
		...
		// Style the end date checkbox and add it to the center panel
		...
		// Style the end date spinner, initialize it, and add it to the center panel
		...
		// Style the end date button, and add it to the center panel
		...
		// Create a bottom panel for confirmation buttons
		...
		// Add the ok & cancel buttons to the bottom panel
		bottomPanel.add(okButton);
		bottomPanel.add(cancelButton);

		// Add the top, center, and bottom panels to the content pane
		gbc = new GridBagConstraints();
		gbc.gridx = 0;
		gbc.gridy = 0;
		gbc.fill = GridBagConstraints.HORIZONTAL;
		...
		// Add action listeners to the start date and end date calendars
	 ...
	 * @param e the action event (pressing ok button)
	 */
	 ...
	 * @param e the action event (pressing cancel button)
	 */
	...
	/**
	 * Change the style on whether end date checkbox is checked. 
	 * If it is checked, enable end date JSpinner and Button. 
	 * @param e the action event (clicking the end date checkbox)
	 */
	...
	/**
	 * Show the start date calendar. 
	 * @param e the action event (clicking on the start date button)
	 */
	...
	/**
	 * Show the end date calendar
	 * @param e the action event (clicking on the end date button)
	 */
	...
	/**
	 * Create a new project dialog. If the result is not CANCELLED, 
