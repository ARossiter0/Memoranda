 ...
 * Revision info     $RCSfile: LectureTable.java,v $ $Revision: 1.26 $ $State: Exp $  
 *
 ...
 * Lectures and subLectures logically.</p>
 *
 * <p>
 * Datamodel is LectureTableModel whick is not used directly but
 * via LectureTableSorter whick extends LectureTableModel and
 * adds sorting capability.
 * </p>
 *
 * <p>
 * To make this class simpler, most cellrendering code
 * has been moved to LectureTreeTableCellRenderer.
 * </p>
 *
 * <p>Article about <a href="http://java.sun.com/products/jfc/tsc/articles/treetable1/">treetables</a>.</p>
 * 
 * @see	main.java.memoranda.ui.LectureTreeTableCellRenderer
 * @version $Id: LectureTable.java,v 1.26 2007/01/05 10:33:26 alexeya Exp $
 * @author $Author: alexeya $
 */
public class LectureTable extends JTable {

    public static final int Lecture_ID = 100;

    public static final int Lecture = 101;

    protected TreeTableCellRenderer tree;

    protected LectureTableModel model;
    
    protected TreeTableModelAdapter modelAdapter;
    
    protected LectureTreeTableCellRenderer renderer;
    ...
    public LectureTable() {
        ...
        CurrentProject.addProjectListener(new ProjectListener() {
            public void projectChange(Project p, NoteList nl, LectureList tl,
                    ResourcesList rl) {
            }
    ...
    private void initTable() {
		...
		//model = new LectureTableModel();
		model = new LectureTableSorter( this );
		...
		renderer = new LectureTreeTableCellRenderer(this);
		
		
		tree.setCellRenderer(renderer);
		setDefaultRenderer(TreeTableModel.class, tree);
		setDefaultRenderer(Integer.class, renderer);
		setDefaultRenderer(LectureTable.class, renderer);
		...
		getColumn( "% " + Local.getString("done") ).setCellEditor(new LectureProgressEditor());
		
		// TODO: editor for Lecture progress
     ...
     */
	 public class TreeTableCellRenderer extends JTree implements // {{{
        ...
        public void setRowHeight(int rowHeight) {
            if (rowHeight > 0) {
                super.setRowHeight(rowHeight);
                if (LectureTable.this != null
                        && LectureTable.this.getRowHeight() != rowHeight) {
                    LectureTable.this.setRowHeight(getRowHeight());
                }
            }
        }
        ...
        public void setBounds(int x, int y, int w, int h) {
            super.setBounds(x, 0, w, LectureTable.this.getHeight());
        }
